#CREATE test
    ...
    CREATE TablE FLOAT_test2 (Var1 float, var2 int not null, primary key(var2));

#INSERT INTO test
    insert into FLOAT_test (var1, Var2, VAR3) values ( 2.355, -0.000008, 0);
    insert into FLOAT_test (var1, Var2, vAr4, VAR3) values ( 267.45, 0.000668, 7684.23, -56.00);
    insert into FLOAT_test (vAr4, VAR3) values (9000.98, 32242.7);
    insert into FLOAT_test2(var2) values (8);
...
#WHERE test (WHERE is shared between SELECT, UPDATE and DELETE)
    ...
    select var1, Var2 from FLOAT_test where Var2 = 0;
    ...
    select * from FLOAT_test where VAR3 <> 0;
    select * from FLOAT_test where VAR3 between -34345 and 0;
