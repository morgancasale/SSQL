...
bool Table::find_Rows_by_value(const string &data, const int & col_i, vector<int> &foundRows) {
    ...
    if(elementsTypes[col_i]=="string" or elementsTypes[col_i]=="text"){
